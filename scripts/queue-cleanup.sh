...
# the script here under set -e. Deliberately kept separate from ERRORS:
# a failed notification about the queue state is a different problem
# than a failed queue fix, and either one succeeding/failing shouldn't
# mask the other in the final summary below.

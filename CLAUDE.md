...
- Dashboard: service health (**+ Prowlarr indexer status**, see below), library stats (**+ disk space, missing counts**, see below), active downloads, **upcoming releases** (see below), recent activity (local time, readable labels)

...
- Dashboard: service health (**+ Prowlarr indexer status**, see below), **automation health** (see below), library stats (**+ disk space, missing counts**, see below), active downloads, **stuck downloads** (see below), **upcoming releases** (see below), recent activity (local time, readable labels)

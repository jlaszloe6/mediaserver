...
- Dashboard: service health, **automation health** (see below), library stats, active downloads, **stuck downloads** (see below), recent activity (local time, readable labels)
